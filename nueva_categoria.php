            ...
            <div class="max-w-2xl mx-auto">
                <div class="flex items-center gap-4 mb-10">
                    ...
                    <h1 class="font-headline-md text-headline-md text-on-background uppercase tracking-tighter italic">
                        <?php echo $is_edit ? 'Editar Categoría' : 'Añadir Nueva Categoría'; ?>
                    </h1>
                </div>
                <form method="post" action="controllers/AdminController.php" class="space-y-8">
                    <input type="hidden" name="action"
                        value="<?php echo $is_edit ? 'update_category' : 'create_category'; ?>">
                    <?php if ($is_edit): ?>
                    ...
                    <div class="bg-white border-4 border-on-background p-8 brand-shadow relative">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input name="nombre"
                                    value="<?php echo $is_edit ? htmlspecialchars($categoria->nombre) : ''; ?>" required
                                    ...
                                    placeholder="Ej. Caramelos, Chocolates, Gomitas" type="text" />
                            </div>
                        </div>
                    </div>
