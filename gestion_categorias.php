                ...
                <div class="bg-white border-4 border-on-background brand-shadow overflow-hidden">
                    <table class="w-full text-left border-collapse">
                        ...
                        <div class='flex gap-4 justify-center'>
                            <a href='nueva_categoria.php?edit=" . $row['id'] . "' class='px-4 py-2 bg-primary text-on-primary font-black uppercase border-2 border-on-background brand-shadow btn-active hover:bg-primary-container transition-colors text-sm'>Editar</a>
                            <a href='controllers/AdminController.php?action=delete_category&id=" . $row['id'] . "' class='px-4 py-2 bg-error text-on-error font-black uppercase border-2 border-on-background brand-shadow btn-active hover:bg-red-700 transition-colors text-sm' onclick='return confirm(\"¿Estás seguro? Esto podría afectar a los productos asociados.\")'>Eliminar</a>
                        </div>
                      </td>";
                                echo "</tr>";
                            }
