                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-btns" style="justify-content: flex-end;">
                                                    ...
                                                    <a href="add_category.php?delete=<?php echo $cat['id']; ?>" class="btn-delete" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?')"><i class="fa-solid fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
